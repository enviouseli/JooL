...
import RegistrationMembershipTypeScreen from "../pages/RegistrationMembershipTypeScreen";
import RegistrationDetailsCarerScreen from "../pages/RegistrationDetailsCarerScreen";
import RegistrationDetailsCareBuddyScreen from "../pages/RegistrationDetailsCareBuddyScreen";
...
const LoginRoutes = () => {
  ...
  return (
    ...
    >
      ...
      />
      <Stack.Screen
        name="RegistrationMembershipTypeScreen"
        component={RegistrationMembershipTypeScreen}
        options={{ title: false }}
      />
      <Stack.Screen
        name="RegistrationDetailsCarerScreen"
        component={RegistrationDetailsCarerScreen}
        options={{ title: false }}
      />
      <Stack.Screen
        name="RegistrationDetailsCareBuddyScreen"
        component={RegistrationDetailsCareBuddyScreen}
        options={{ title: false }}
      />
      <Stack.Screen
        name="HomePage"
...
function StackRouts() {
  return (
    ...
    >
      ...
      />
      <Stack.Screen
        name="POSMScanActivity"
        component={POSMScanActivity}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="POSMScanMood"
        component={POSMScanMood}
        options={{ headerShown: false }}
      />
      <Stack.Screen
      ...
      <View style={{ padding: 20, borderTopWidth: 1, borderTopColor: "#ccc" }}>
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <Text style={{ fontSize: 15, marginLeft: 5 }}>Care Circle</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <Text style={{ fontSize: 15, marginLeft: 5 }}>Care Store</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => navigation.navigate("CareAcademy")}
          style={{ paddingVertical: 5 }}
        >
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <Ionicons
              ...
              color="#0A2249"
            />
            <Text style={{ fontSize: 15, marginLeft: 5 }}>Care Academy</Text>
          </View>
        </TouchableOpacity>
      </View>
    </DrawerContentScrollView>
