...
const RegistrationDetailsCarerScreen = () => {
  ...
  const createLocationAlert = () =>
    ...
    // Alert.alert("Thank you", "Thank you for completing the registration.", [
    //   {
    //     text: "Cancel",
  ...
  const questions = {
    ...
    care_area: ["Allow us to know the location where care is provided?","text"],
  ...
  let inputElement = (currentStage in questions)?questions[currentStage][1]:'text';
  return (
        ...
        <View style={[CommonStyles.subContainer, { backgroundColor: "white" }]}>
          ...
          ></FlatList> */}
            ...
            <KeyboardAvoidingView>
              ...
              { inputElement=='text' && <ChatTextField textMessage={textMessage} setTextMessage={setTextMessage} handleMessage={handleMessage}></ChatTextField> }
              { inputElement=='select' && <ChatDropDown textMessage={textMessage} setTextMessage={setTextMessage} handleMessage={handleMessage}></ChatDropDown>}
              { inputElement=='date' && <ChatCalendar handleMessageDate={handleMessageDate}></ChatCalendar>}
            </KeyboardAvoidingView>
          </View>
          <View
          ...
          >
            {completeButton && (
              <TouchableOpacity
                ...
                onPress={() => createLocationAlert()}
              >
                <Text style={[CommonStyles.DarkBlueText]}>Profile Complete</Text>
              </TouchableOpacity>
            )}
          </View>
        </View>
