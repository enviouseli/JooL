  ...
  return (
    <SafeAreaView>
     <HeaderMain text="My Profile"
      ...
      <ProfileCards 
      text="Edit Profile" 
      icon=<FontAwesome5 name="user" size={19} color="black" style={{marginHorizontal:10}}/>
      page={() => navigation.navigate("EditProfile")}
      />

      <ProfileCards 
      text="Payment Options" 
      icon=<MaterialIcons name="payment" size={19} color="black" style={{marginHorizontal:10}}/>
      page={() => {}}
      />

      <ProfileCards 
      text="Notifications" 
      icon=<Ionicons name="notifications-outline" size={19} color="black" style={{marginHorizontal:10}}/>
      page={() => {}}
      />

      <ProfileCards 
      text="Security" 
      icon=<Octicons name="shield-check" size={19} color="black" style={{marginHorizontal:10}}/>
      page={() => {}}
      />

      <View style={{flexDirection:"row", justifyContent:"space-between", marginVertical:20}}>
            <View style={{flexDirection:"row", justifyContent:"flex-start", width:"70%"}}>
            <Ionicons name="language" size={19} color="black" style={{marginHorizontal:10}}/>
      ...
      <ProfileCards 
      text="Dark Mode" 
      icon=<Entypo name="eye" size={19} color="black" style={{marginHorizontal:10}}/>
      page={() => {}}
      />

      <ProfileCards 
      text="Terms & Conditions" 
      icon=<MaterialCommunityIcons name="shield-alert" size={19} color="black" style={{marginHorizontal:10}}/>
      page={() => {}}
      />
      <ProfileCards 
      text="Help Center" 
      icon=<MaterialIcons name="help" size={19} color="black" style={{marginHorizontal:10}}/>
      page={() => {}}
      />

      <ProfileCards 
      text="Intive Friends" 
      icon=<MaterialCommunityIcons name="email-send-outline" size={19} color="black" style={{marginHorizontal:10}}/>
      page={() => {}}
      />

      <ProfileCards 
      text="Log out" 
      icon=<AntDesign name="logout" size={19} color="black" style={{marginHorizontal:10}}/>
      page={() => {}}
      />
